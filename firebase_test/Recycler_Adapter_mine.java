...
public class Recycler_Adapter_mine extends RecyclerView.Adapter<Recycler_Adapter_mine.ViewHolder> {
        ...
        public ViewHolder(@NotNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mineposition = getAdapterPosition();
                    if (mineposition != RecyclerView.NO_POSITION) {
                        Intent intent = new Intent(itemView.getContext(), Mine_book_info.class);
